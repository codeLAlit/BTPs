...
generator_fake.load_state_dict(torch.load("../checkpoint/dcgan.pth")['generator'])
generator_fake.eval()
...
valid_loader = DataLoader(valid_dataset, batch_size=8, shuffle=False, num_workers=1)
...
if os.path.exists('../checkpoint/best_model_openunet3_final.pth'):
    model = torch.load('../checkpoint/best_model_openunet3_final.pth', map_location=DEVICE)
...
if TRAINING:
    ...
    for i in range(0, EPOCHS):
        ...
        if best_iou_score > valid_logs['multi_class_ce']:
            ...
            torch.save(model, '../checkpoint/best_model_openunet3.pth')
            print('Model saved!')

torch.save(model, '../checkpoint/best_model_openunet3_final.pth')

"""### Prediction on Test Data"""

# if os.path.exists('/content/drive/MyDrive/BTPII/checkpoint/best_model_openunet2.pth'):
#     best_model = torch.load('/content/drive/MyDrive/BTPII/checkpoint/best_model_openunet2.pth', map_location=DEVICE)
...
# sample_preds_folder = '/content/drive/MyDrive/BTPII/sample_predictions_openset_gan/'
...
# print(gt_mask[160, 160], pred_mask[160, 160])
